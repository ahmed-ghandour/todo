...
class AppCubit extends Cubit<AppStates>
{
  ...
  {
    return ' once upon time in cameroon';
  }
  void createDatabase ()
  {
     openDatabase(
        ...
        onCreate: (database,version) async
        {
          ...
          await database.execute('CREATE TABLE tasks (id INTEGER PRIMARY KEY,title TEXT,time TEXT, date TEXT, status TEXT)').then((value)
          {
            print('table created');
